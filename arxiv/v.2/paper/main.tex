...
just that later diagrams contain more states. It is that one can watch,
step by step, the growth from activation, to initialization, to
monitored action, to conditional interaction, to environmental
decision, and finally to persistent multi-state embodied organization.
